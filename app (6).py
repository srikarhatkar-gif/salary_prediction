...
Original file is located at
    https://colab.research.google.com/drive/1W6svm1hMwq8LozszpZ7n7oXuLsE9eFS1
"""
...
!streamlit run /usr/local/lib/python3.12/dist-packages/colab_kernel_launcher.py &>/dev/null&
